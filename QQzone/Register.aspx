...
<body>
    ...
    <form id="form1" runat="server">
        ...
        <br />
            ...
            <br />
            <br />
            密码：<asp:TextBox ID="NewPwd" runat="server" TextMode="Password"></asp:TextBox>
            <br />
            <br />
            再输入密码：<asp:TextBox ID="reNewPwd" runat="server" TextMode="Password"></asp:TextBox>
            ...
            性别：<asp:RadioButtonList ID="rdlSex" runat="server" RepeatDirection="Horizontal" RepeatLayout="Flow">
...
<%--            </script>--%>
            ...
            <br />
            <br />
            <asp:Button ID="btnRegister" runat="server" OnClick="btnRegister_Click1" Text="确认" />
        </div>
    </form>
</body>
</html>
