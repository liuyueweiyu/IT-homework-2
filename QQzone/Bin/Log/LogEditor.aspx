<%@ Page Language="C#" AutoEventWireup="true" CodeFile="LogEditor.aspx.cs" Inherits="Log_LogEditor" %>
...
<body>
    ...
    <form id="form1" runat="server">
        ...
        <asp:LinkButton ID="toMyhistory" Text="过往动态" runat="server" PostBackUrl="~/History/Myhistory.aspx"></asp:LinkButton>
            ...
            <br />
            <br />
            <asp:Button ID="btnSub" runat="server" Text="修改日志" OnClick="btnSub_Click" />
